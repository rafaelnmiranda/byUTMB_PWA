...
const Card = ({
  ...
  return (
    <Wrapper
      {...baseProps}
      className="group flex flex-col gap-4 rounded-3xl border border-subtle bg-card-surface p-5 shadow-subtle transition-transform hover:-translate-y-0.5 hover:border-strong hover:bg-[var(--card-hover)]"
    >
      {badge && (
